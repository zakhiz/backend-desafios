...
const CRUD = async() =>{
    ...
    //! 1)
    // let result = await studentsModel.updateOne({$and :[{nombre : "Lucas"},{apellido : "Blanco"}]},{$set :{dni : "3525322466"}});
    // console.log(result);
    //! 2)
    // let result = await studentsModel.updateMany({},{ingreso : false})
    // console.log(result);
    //! 3)
